...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_permohonanktp as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE alamat LIKE '%$pencarian%' ORDER BY no_permohonanKtp ASC") or die (mysqli_error($koneksi)) ;

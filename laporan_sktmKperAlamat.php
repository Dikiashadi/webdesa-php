...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmkesehatan as k JOIN tb_penduduk as p ON k.nik=p.nik  WHERE alamat LIKE'%$pencarian%' ORDER BY no_sktmkesehatan") or die (mysqli_error($koneksi)) ;

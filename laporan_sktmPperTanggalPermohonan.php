...
class PDF extends FPDF
{
  function Header(){
    ...
    $this->Image('assets/logo/logo.png',80,12,27);
     ...
     $this->Cell(100,7,'PEMERINTAH KOTA BUMIGORA',0,1,'L');
      $this->Cell(102);
     $this->SetFont('Arial','B',16);
     $this->Cell(100,7,'KECAMATAN BUMIGORA',0,1,'L');
     
     $this->Cell(94);
     $this->SetFont('Arial','i',10  );
     $this->Cell(90,7,'Jl.BUMIGORA',0,1,'L');
     //garis bawah double
...
$pdf->AddPage();
  ...
  $pdf->SetFont('Arial','B','16');
      $pdf->Cell(270,7,'Laporan Permohonan SKTM Pendidikan',0,1,'C');
       $pdf->Cell(270,7,'Berdasarkan'.$filter,0,1,'C');
...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmpendidikan as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE tgl_sktmPendidikan between '$tglawal' and '$tglakhir' ORDER BY tgl_sktmPendidikan ASC") or die (mysqli_error($koneksi)) ;
...
$pdf->Cell(47);
$pdf->Cell(41,8,'Sekolah Tujuan',0);
$pdf->Cell(10,8,':',0);
$pdf->Cell(30,8,$row['sekolah_tujuan'],0,1);

$pdf->Cell(30);
$pdf->Cell(39,8,'Tempat/Tanggal Lahir',0);
$pdf->Cell(10,8,' :',0);
$pdf->Cell(35,8,$row['tempatLahir'].', '.$t,0,1);
...
$pdf->Cell(79);
$pdf->Cell(39,8, 'RT. '.$row['rt']." RW. ".$row['rw'],0,1);

$pdf->Cell(79);
$pdf->Cell(39,8,'Kelurahan '.$row['kelurahan'],0,1);

$pdf->Cell(79);
$pdf->Cell(39,8,'Kecamatan Bumigora',0,1);

$pdf->Cell(79);
$pdf->Cell(39,8,'Kota Bumigora',0,1);

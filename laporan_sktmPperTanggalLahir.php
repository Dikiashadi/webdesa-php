...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmpendidikan as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE tanggalLahir between '$tglawal' and '$tglakhir' ORDER BY tanggalLahir ASC") or die (mysqli_error($koneksi)) ;

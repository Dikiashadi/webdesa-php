...
<div class="row" id="contentInput" >
          <div class="col-lg-12">
            <h1>Laporan Permohonan SKTM Kesehatan</h1>
            <ol class="breadcrumb">
              <li class="active"> Laporan SKTM Kesehatan</li>
            <?php echo"<li class='active'>Berdasarkan $filter</li>"?>
            <?php echo"<li class='active'>Dari Tanggal $tglawal Sampai $tglakhir</li>"?>
            </ol>
          </div>
      </div>
      <form  action="laporan_sktmKperTanggalLahir.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
     ...
     <div class="table-responsive-sm">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_sktmkesehatan as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE tanggalLahir between '$tglawal' and '$tglakhir' ORDER BY tanggalLahir ASC";
     ...
     echo"<script>location='formlaporan_sktmKes.php';</script>";
      }
      }
       ?>  
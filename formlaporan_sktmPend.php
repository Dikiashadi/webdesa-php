...
<div class="row" id="contentInput" >
          <div class="col-lg-12">
            <h1>Laporan SKTM Pendidikan</h1>
            <ol class="breadcrumb">
              <li class="active">Surat Keterangan Tidak Mampu Untuk Pendidikan</li>
              
            </ol>
          </div>
      </div>
       
 <a   href="laporan_sktmPsemua.php" type="button" class="btn btn-danger"  style="align:center;"><i class="fa fa-print"></i> CETAK SEMUA DATA SKTM PENDIDIKAN</a>
       <hr>  
               ...
               <div class="form-group form-group-sm">
                  <label class=" control-label col-sm-2" for="cbkelurahan">Jenis Filter</label>
                   <div class="col-sm-3">
                    ...
                    <option value="Sekolah Tujuan">Sekolah Tujuan</option>
...
if($jenis=="NIK/No Permohonan/Nama"){
  ?><div class="panel panel-info">
          ...
          <div class="panel-body">
          <form method="POST" action="laporan_sktmPperNik.php" id="nik">
          <div class="form-group form-group-sm">
                  <div class="form-group form-group-sm">
...
<?php
  ...
  ?><div class="panel panel-info">
          ...
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperTempat.php" id="tempat">
          <div class="form-group form-group-sm">
                   <div class="form-group form-group-sm">
...
<?php
  ...
  <div class="panel panel">
          ...
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperTanggalLahir.php" id="tempat">
...
<?php
  ...
  ?><div class="panel panel-info">
          ...
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperAlamat.php" id="tempat">
          <div class="form-group form-group-sm">
                   <div class="form-group form-group-sm">
...
<?php
  ...
  ?><div class="panel panel-info">
          ...
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperKelurahan.php" id="tempat">
           <div class="form-group form-group-sm">
                  <label class=" control-label col-sm-2" for="txtcari">Kelurahaan</label>
                   <div class="col-sm-3">
                    ...
                    <option value="">--Pilih--</option>
                    <option value="Bumigora">Bumigora</option>
                    <option value="Mataram">Mataram</option>
                    <option value="Gerung">Gerung</option>
...
<?php
  ...
  <div class="panel panel">
          ...
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperTanggalPermohonan.php" id="tempat">
            <form class="form-inline">
              <div class="form-group col-sm-3">
                <label for="tgl_awal">Dari Tanggal</label>
                <input type="date" class="form-control" name="tgl_awal">
...
<?php
  ...
  ?><div class="panel panel-info">
          ...
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperNomorkk.php" id="tempat">
          <div class="form-group form-group-sm">
                   <div class="form-group form-group-sm">
...
<?php
}if($jenis=="Sekolah Tujuan"){
  ?><div class="panel panel-info">
          <div class="panel-heading-none">
          </div>
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperSekolah.php" id="tempat">
          <div class="form-group form-group-sm">
                   <div class="form-group form-group-sm">
                    <label class="control-label col-sm-2">Sekolah Tujuan</label>
                     <div class="col-sm-3">
                    <input type="text" class="form-control" name="txtcari" id="txtcari" required placeholder='Sekolah Tujuan'>
                </div>
              </div>
              <div class="col-sm-3">
              <input type="hidden" class="form-control" name="txtfilter" id="txtfilter" value="Sekolah Tujuan">
              <div class="col-sm-3">
                <input type="submit" align="right" class="btn btn-danger"  value="Cari" name="cari" id="cari">
</div>
</div>
...
<?php
  ...
  ?><div class="panel panel-info">
          ...
          <div class="panel-body">
          <form method="POST" action="filter_sktmPperKet.php" id="tempat">
          <div class="form-group form-group-sm">
                   <div class="form-group form-group-sm">
              ...
              <div class="col-sm-3">
              <input type="hidden" class="form-control" name="txtfilter" id="txtfilter" value="Keterangan">
              <div class="col-sm-3">
                <input type="submit" align="right" class="btn btn-danger"  value="Cari" name="cari" id="cari">
</div>
</div>

...
<div class="row" id="contentInput" >
          <div class="col-lg-12">
            <h1>SKTM Pendidikan</h1>
            <ol class="breadcrumb">
              <li class="active">Surat Keterangan Tidak Mampu</li>
              <li class="active">Untuk Pendidikan</li>
            </ol>
          </div>
      </div>
       <div class="panel panel-info">
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="table-responsive-sm">
              <table class="table table-bordered table-hover reverse-table">
                <tr>
                  <th>NO</th>
                  <th>NO SKTM</th>
                  <th>NIK</th>
                  ...
                  <th>Keterangan</th>
                 <th><a href="sktm_pendidikan.php" type="button" align="right" class="btn btn-success">Tambah Data</a></th>
                </tr>
 <?php
     if(!ISSET($_POST['cari'])){
        $no= 1;
       $query="SELECT * FROM tb_sktmpendidikan as p JOIN tb_penduduk as d ON p.nik=d.nik";
      ...
      ?>
                <tr>
                  ...
                  <td><?php echo $row['keterangan']; ?></td>
                   ...
                   <td colspan="2" style="text-align: center;">
                    <a   href="print_sktmPendidikan.php?id=<?php echo $row['no_sktmPendidikan'];?>" type="button" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>
       ...
       if(ISSET($_POST['cari'])){
        ...
        $perintah="SELECT * FROM tb_sktmpendidikan as k JOIN tb_penduduk as d ON k.nik=d.nik WHERE no_sktmPendidikan LIKE '%$cari%' OR d.nama LIKE '%$cari%'  OR k.nik LIKE '%$cari%' "   ;
        ...
        <tr>
                  <td align="center"><?php echo $no++; ?></td>
                  <td><?php echo $r['no_sktmPendidikan']; ?></td>
                  <td><?php echo $r['nik']; ?></td>
                  <td><?php echo $r['nama']; ?></td>
                   <td><?php echo $r['tempatLahir'].", ".$r['tanggalLahir']; ?></td>
                  <td><?php echo $r['alamat']." RT.".$r['rt']." RW.".$r['rw']." Kelurahan ".$r['kelurahan']." Kecamatan Bumigora Kota Bumigora"; ?></td>
                  <td><?php echo $r['no_kk']; ?></td>
                  <td><?php echo $r['tgl_sktmPendidikan']; ?></td>
                  <td><?php echo $r['sekolah_tujuan']; ?></td>
                  <td><?php echo $r['keterangan']; ?></td>
                    <td colspan="2" style="text-align: center;">
                    <a   href="print_sktmPendidikan.php?id=<?php echo $r['no_sktmPendidikan'];?>" type="button" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>

...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_ktpPerTanggalLahir.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
     ...
     <div class="table-responsive-sm">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_permohonanktp as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE tanggalLahir between '$tglawal' and '$tglakhir'  ORDER BY no_permohonanKtp ASC";

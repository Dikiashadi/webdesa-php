...
$pdf->AddPage();
  ...
  $pdf->SetFont('Arial','B','16');
      ...
      $pdf->Cell(270,7,' Dari '.$tglawal.' Sampai '.$tglakhir,0,1,'C');
//-------------Select data di database------------------------------
$no=1;
$pdf->SetFont('Arial','','10');

$kasus=mysqli_query($koneksi,"SELECT * FROM tb_penduduk WHERE tanggalLahir between '$tglawal' and '$tglakhir'  ORDER BY tanggalLahir ASC") or die (mysqli_error($koneksi)) ;

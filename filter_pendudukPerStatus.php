...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_pendudukPerStatus.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_penduduk WHERE statusPerkawinan='$cari'";

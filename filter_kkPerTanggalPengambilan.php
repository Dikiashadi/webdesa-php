...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_kkPerTanggalPengambilan.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
     ...
     <div class="table-responsive-sm">
      ...
      <?php
       ...
       echo"<input type='hidden' class='form-control' name='txtfilter' id='txtfilter' value='$filter'>";
        ...
        $perintah="SELECT * FROM tb_permohonankk as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE tgl_pengambilan between '$tglawal' and '$tglakhir' ORDER BY tglPermohonan ASC";

...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_pendudukPerGol.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_penduduk WHERE golDarah='$cari'";

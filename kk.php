...
<div class="container">
 ...
 <div class="row" id="contentJurusan">
                    <div class="col-lg-12">
                  <?php
                    $q="SELECT max(no_permohonankk) as maxKode from tb_permohonankk";   
        ...
        ?>
 <form  action="simpan_kk.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  <div class="form-group form-group-sm">
              ...
              <div class="form-group form-group-sm">
                    <input type="hidden" class="form-control" name="txtnik" id="txt_tglLahir"  value="<?php echo $r['nik']; ?>">
              ...
              <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-4">
                    <textarea class="form-control" name="txtalamat" cols="40" rows="5" id="txtalamat" readonly ><?php echo $r['alamat']." RT.". $r['rt']." RW.".$r['rw']." Kelurahan ".$r['kelurahan']." Kecamatan Bumigora Kota Bumigora" ; ?></textarea>
                </div>
              </div>
               <div class="form-group form-group-sm">
              ...
              <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-3">
                    <input type="date" class="form-control" name="txt_permo" id="txt_permo" placeholder="yyyy-mm-dd" required>
                </div>
              </div>
               <div class="form-group form-group=sm">

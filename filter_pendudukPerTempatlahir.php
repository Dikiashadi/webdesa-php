...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_pendudukPerTempatlahir.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      if(ISSET($_POST['cari'])){
       ...
       $filter=mysqli_real_escape_string($koneksi,$_POST['txtfilter']);
        ...
        $perintah="SELECT * FROM tb_penduduk WHERE tempatLahir LIKE '%$cari%' OR alamat LIKE '%$cari%' OR kelurahan LIKE '%$cari%' OR agama LIKE '%$cari%' OR pendidikan LIKE '%$cari%' OR statusPerkawinan LIKE '%$cari%' OR golDarah LIKE '%$cari%' OR pekerjaan LIKE '%$cari%'" ;

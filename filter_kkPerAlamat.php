...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_kkPerAlamat.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
     ...
     <div class="table-responsive-sm">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_permohonankk as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE alamat LIKE '%$cari%' ORDER BY no_permohonankk ASC";

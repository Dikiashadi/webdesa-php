...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_ktpPerTempatlahir.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
     ...
     <div class="table-responsive-sm">
      ...
      if(ISSET($_POST['cari'])){
       ...
       $filter=mysqli_real_escape_string($koneksi,$_POST['txtfilter']);
        ...
        $perintah="SELECT * FROM tb_permohonanktp as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE tempatLahir LIKE '%$cari%' ORDER BY no_permohonanKtp ASC";

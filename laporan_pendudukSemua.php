  ...
  function Header(){
    ...
    $this->Image('assets/logo/logo.png',80,12,27);
     ...
     $this->Cell(100,7,'PEMERINTAH KOTA BUMIGORA',0,1,'L');
      $this->Cell(102);
     $this->SetFont('Arial','B',16);
     $this->Cell(100,7,'KECAMATAN BUMIGORA
     ',0,1,'L');
...
$pdf->AddPage();
  $pdf->SetFont('Arial','B','16');
      $pdf->Cell(270,7,'Laporan Semua Penduduk',0,1,'C');
...
include'koneksi.php';
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_penduduk  ORDER BY tanggalLahir ASC") or die (mysqli_error($koneksi)) ;
...
$pdf->Cell(10,8,' :',0);
$pdf->Cell(30,8,$row['nomorTlp'],0,0);

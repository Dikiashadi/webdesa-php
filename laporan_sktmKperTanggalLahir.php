...
if(@$_POST['cetak']){
  ...
  $pdf->SetFont('Arial','B','16');
     $pdf->Cell(270,7,'Laporan Permohonan SKTM Kesehatan',0,1,'C');
...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmkesehatan as k JOIN tb_penduduk as p ON k.nik=p.nik  WHERE tanggalLahir between '$tglawal' and '$tglakhir' ORDER BY tanggalLahir ASC") or die (mysqli_error($koneksi)) ;
...
$pdf->Cell(10,8,':',0);
$pdf->Cell(30,8,$row['no_sktmkesehatan'],0,0);

$pdf->Cell(45);
$pdf->Cell(40,8,'Tanggal Permohonan',0);
$pdf->Cell(10,8,' :',0);
$pdf->Cell(30,8,$row['tgl'],0,1);

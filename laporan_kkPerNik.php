...
$pdf->AddPage();
  $pdf->SetFont('Arial','B','16');
      $pdf->Cell(270,7,'Laporan Permohonan KK Per Penduduk',0,1,'C');
  if(@$_POST['cetak']){
...
$kasus="SELECT * FROM tb_permohonankk as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE k.nik='$cari' OR nama LIKE '%$cari%' OR no_permohonankk='$cari' ORDER BY no_permohonankk ASC" ;

$result=mysqli_query($koneksi,$kasus);
                      if(!$result){

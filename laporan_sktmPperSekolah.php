...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmpendidikan as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE sekolah_tujuan LIKE'%$pencarian%'") or die (mysqli_error($koneksi)) ;

...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_pendudukPerPekerjaan.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_penduduk WHERE pekerjaan LIKE '%$cari%'";

...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_pendudukPerKelurahan.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_penduduk WHERE  kelurahan='$cari'";

...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmkesehatan as k JOIN tb_penduduk as p ON k.nik=p.nik  WHERE tgl between '$tglawal' and '$tglakhir' ORDER BY tanggalLahir ASC") or die (mysqli_error($koneksi)) ;

...
class PDF extends FPDF
{
  function Header(){
    ...
    $this->Image('assets/logo/logo.png',80,12,27);
     ...
     $this->Cell(90,7,'Jl.TBUMIGORA',0,1,'L');
     //garis bawah double
...
$pdf->AddPage();
  ...
  $pdf->SetFont('Arial','B','16');
      $pdf->Cell(270,7,'Laporan Permohonan KK Berdasarkan'.$filter,0,1,'C');
...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_permohonankk as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE tgl_pengambilan between '$tglawal' and '$tglakhir' ORDER BY no_permohonankk ASC") or die (mysqli_error($koneksi)) ;
...
$pdf->Cell(79);
$pdf->Cell(39,8,'Kecamatan Bumigora',0,0);

...
$pdf->AddPage();
  $pdf->SetFont('Arial','B','16');
      $pdf->Cell(270,7,'Laporan Semua SKTM Kesehatan',0,1,'C');

//-------------Select data di database------------------------------
$no=1;
$pdf->SetFont('Arial','B','10');

$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmkesehatan as k JOIN tb_penduduk as p ON k.nik=p.nik ORDER BY no_sktmkesehatan ASC") or die (mysqli_error($koneksi)) ;

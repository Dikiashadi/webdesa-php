...
<div class="row" id="contentInput" >
      ...
      <form  action="laporan_kkPerKelurahan.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
     ...
     <div class="table-responsive-sm">
      ...
      <?php
        ...
        $perintah="SELECT * FROM tb_permohonankk as k JOIN tb_penduduk as p ON k.nik=p.nik WHERE kelurahan LIKE '%$cari%' ORDER BY no_permohonankk ASC";

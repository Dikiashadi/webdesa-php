...
if(@$_POST['cetak']){
  ...
  $pdf->SetFont('Arial','B','16');
      $pdf->Cell(270,7,'Laporan SKTM Kesehatan Berdasarkan',0,1,'C');
...
$kasus=mysqli_query($koneksi,"SELECT * FROM tb_sktmkesehatan as k JOIN tb_penduduk as p ON k.nik=p.nik  WHERE tempatLahir LIKE'%$pencarian%' ORDER BY no_sktmkesehatan") or die (mysqli_error($koneksi)) ;
